...
import com.fheebiy.http.lite.exception.HttpNetException;
import com.fheebiy.http.lite.exception.HttpServerException;
import com.fheebiy.http.lite.exception.HttpServerException.ServerException;
...
import com.fheebiy.http.lite.response.InternalResponse;
...
public class ApacheHttpClient extends LiteHttpClient {
    ...
    @Override
    public com.fheebiy.http.lite.data.NameValuePair[] head(String uri) {
        ...
        while (retry) {
            try {
                ...
                if (!Thread.currentThread().isInterrupted()) {
                    ...
                    if (headers != null) {
                        com.fheebiy.http.lite.data.NameValuePair hs[] = new com.fheebiy.http.lite.data.NameValuePair[headers.length];
                        for (int i = 0; i < headers.length; i++) {
                            ...
                            hs[i] = new com.fheebiy.http.lite.data.NameValuePair(name, value);
                        }
